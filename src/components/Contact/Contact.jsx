            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6">
                    <div className='col-span-2 space-y-3'>
                        ...
                        >
                            {" "} Let collaborate on your upcoming car rental venture</h1>
                        <p className='text-gray-400'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Exercitationem, cumque nostrum. Nesciunt quibusdam aut
                            molestiae soluta esse! Sint, explicabo impedit.
                        </p>
                    </div>
